      ...
      >
        ...
        <nav className="mr-14 hidden md:block">
          <ul className="flex justify-between gap-x-6 ">
            <li className="underline decoration-transparent decoration-[2px]  hover:decoration-inherit underline-offset-4 hover:underline-offset-8 duration-200">
              <a href={"#hero"}>Beranda</a>
            </li>
            <li className="underline decoration-transparent decoration-[2px] hover:decoration-inherit underline-offset-4 hover:underline-offset-8 duration-200">
              <a href={"#product"}>Kopi</a>
            </li>
            <li className="underline decoration-transparent decoration-[2px] hover:decoration-inherit underline-offset-4 hover:underline-offset-8 duration-200">
        ...
        <button
          className="block md:hidden flex flex-col w-6 gap-y-[5px]"
          onClick={() => {
            setIsOpen(true);
          }}
        >
          {[0, 1, 2].map((index: number) => {
            return (
              <span
                className={`w-full h-[2px] inline-block  duration-200 ${isTransparent ? "bg-white" : "bg-black"}`}
                key={index}
              ></span>
            );
          })}
